...
```ts
  ...
  20 |     let EmpStatusrow= page.locator("[class*='-table-row--clickable']").filter({hasText:'Part-Time Internship'})
  21 |     console.log(EmpStatusrow)
  22 | 
  23 |     console.log("Employee Status row found:",await EmpStatusrow.count()) 
